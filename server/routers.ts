...
import { rizasecRouter } from "./routers/rizasec";
import { rizasecDetailRouter } from "./routers/rizasec-detail";
import { securitizadorasRouter } from "./routers/securitizadoras";
...
export const appRouter = router({
  ...
  rizasec: router({ getEmissoes: rizasecRouter.getEmissoes, getDetail: rizasecDetailRouter.getDetail }),
  securitizadoras: router({ get: securitizadorasRouter.get }),
  auth: router({
